...
export default {
    ...
    [
      "classic",
      {
        "docs": {
          ...
          "editUrl": "https://github.com/mypalesong/agent-propmt/tree/guide/"
        },
        "blog": false,
        "theme": {
  ...
  "themeConfig": {
    ...
    "footer": {
      ...
      "copyright": "Copyright © 2025 Multi-Agent Prompt Guide. Built with Docusaurus."
    },
    "prism": {
      "theme": {
        "plain": {
